...
{
	public static NeoForgeConfigSpec.IntValue max_transmission_jumps;

	public static NeoForgeConfigSpec.IntValue max_gdo_transmission_distance;
	public static NeoForgeConfigSpec.IntValue max_transceiver_transmission_distance;
	public static NeoForgeConfigSpec.IntValue max_stargate_transmission_distance;
