...
{
	public static final DeferredRegister.Items ITEMS = DeferredRegister.Items.createItems(StargateJourney.MODID);
	...
	/*public static final DeferredItem<Item> UNIVERSE_DIALER = ITEMS.register("universe_dialer", 
