...
public abstract class SGJourneyConfigValue
{
	...
	{
		public NeoForgeConfigSpec.BooleanValue boolean_value;
		
		public BooleanValue(NeoForgeConfigSpec.Builder builder, String path, boolean defaultValue, String comment)
		{
	...
	{
		public NeoForgeConfigSpec.IntValue int_value;
		protected int min;
		protected int max;
		
		public IntValue(NeoForgeConfigSpec.Builder builder, String path, int defaultValue, int min, int max, String comment)
		{
	...
	{
		public NeoForgeConfigSpec.LongValue long_value;
		
		public LongValue(NeoForgeConfigSpec.Builder builder, String path, long defaultValue, long min, long max, String comment)
		{
	...
	{
		public NeoForgeConfigSpec.IntValue red_value;
		public NeoForgeConfigSpec.IntValue green_value;
		public NeoForgeConfigSpec.IntValue blue_value;
		public NeoForgeConfigSpec.IntValue alpha_value;
		
		public RGBAValue(NeoForgeConfigSpec.Builder builder, String path, int red, int blue, int green, int alpha, String comment)
		{
	...
	{
		public NeoForgeConfigSpec.EnumValue<T> enum_value;
		
		public EnumValue(NeoForgeConfigSpec.Builder builder, String path, T defaultValue, String comment)
		{
